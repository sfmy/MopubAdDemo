 ...
 */
public class NativeVideoADActivity extends AppCompatActivity {

    private static final String TAG = "Mopub>>222Reward";
...
//                Toast.makeText(NativeVideoADActivity.this, "初始化成功", Toast.LENGTH_SHORT).show();
//            }
//        });
    ...
    private void initListener() {
        MoPubRewardedVideos.setRewardedVideoListener(new MoPubRewardedVideoListener() {
            ...
            public void onRewardedVideoLoadSuccess(@NonNull String adUnitId) {
                ...
                Toast.makeText(NativeVideoADActivity.this,"激励视频缓存成功",Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onRewardedVideoLoadFailure(@NonNull String adUnitId, @NonNull MoPubErrorCode errorCode) {
                Log.d(TAG, "onRewardedVideoLoadFailure: 激励视频获取失败,错误码: " + errorCode);
                Toast.makeText(NativeVideoADActivity.this,"激励视频获取失败 错误码:" +errorCode,Toast.LENGTH_SHORT).show();
            }
    ...
    private void onClickView() {
        ...
        playTv.setOnClickListener(view -> {
            if (MoPubRewardedVideos.hasRewardedVideo(rewardADId)) {
                ...
                Toast.makeText(NativeVideoADActivity.this,"请先缓存激励视频广告",Toast.LENGTH_SHORT).show();
            }
        });
    }
